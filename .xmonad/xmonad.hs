...
myFont :: String
myFont = "xft:Source Code Pro:weight=regular:size=9:antialias=true:hinting=true"

myModMask :: KeyMask
myModMask = mod1Mask        -- Sets modkey to Alt/Option (mod1mask) or Super/Windows key (mod4mask)
...
myStartupHook = do
    ...
    spawnOnce "conky" -- uses ~/.config/conky/conky.conf by default
